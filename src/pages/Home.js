  ...
  return (
    <>
      ...
      >
        ...
        <Box 
            component="section" 
            id={createSafeId(orderedSectionKeys[0])} 
            sx={firstSectionStyles}
        >
            <Container maxWidth="md">
                ...
                >
                    {allDisplayTitles[orderedSectionKeys[0]]}
                </Typography>
        ...
        {/* Section 5: Classes and Services Available */}
        ...
        <Box component="section" id={createSafeId(orderedSectionKeys[8])} sx={getSectionStyle(8)}>
            <Container maxWidth="md">
                <Typography variant="h2" component="h2">{allDisplayTitles[orderedSectionKeys[8]]}</Typography>
